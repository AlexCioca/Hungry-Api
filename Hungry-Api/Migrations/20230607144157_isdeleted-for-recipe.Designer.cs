...
namespace Hungry_Api.Migrations
{
    ...
    [Migration("20230607144157_isdeleted-for-recipe")]
    partial class isdeletedforrecipe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hungry_Api.DbModels.Message", b =>
                {
            ...
            modelBuilder.Entity("Hungry_Api.DbModels.Ticket", b =>
                {
            ...
            modelBuilder.Entity("Hungry_Api.DbModels.Message", b =>
                {
                    b.HasOne("Hungry_Api.DbModels.User", "Reciver")
                        .WithOne()
                        .HasForeignKey("Hungry_Api.DbModels.Message", "ReciverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Hungry_Api.DbModels.User", "Sender")
                        .WithOne()
                        .HasForeignKey("Hungry_Api.DbModels.Message", "SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
